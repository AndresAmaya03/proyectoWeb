...
<div class="container pb-6 pt-6">
	...
	<form action="./php/usuario_guardar.php" method="POST" class="FormularioAjax" autocomplete="off" >
		...
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Usuario</label><label class="obligatorio">*</label>
				  	<input class="input" type="text" name="usuario_usuario" pattern="[a-zA-Z0-9]{4,20}" maxlength="20" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
					<label>Email</label><label class="obligatorio">*</label>
		...
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Clave</label><label class="obligatorio">*</label>
				  	<input class="input" type="password" name="usuario_clave_1" pattern="[a-zA-Z0-9$@.-]{7,100}" maxlength="100" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
					<label>Repetir clave</label><label class="obligatorio">*</label>
